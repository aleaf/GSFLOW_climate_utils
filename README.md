...
2. run **GSFLOW_plots.py** to generate plots. 
   ...
   * also requires the *.var_name* file, which has meta information on all of the GSFLOW variables. This file can be generated by running GSFLOW in pring mode: gsflow.exe <*.control> -print 
